				...
				<PageContent header={__('CSS Optimization')}>
					...
					<table className="form-table">
						<tbody>
									...
									<td colSpan="2" style={{ paddingTop: "0px" }}>
										<div className="abtf-inner-table">
											...
											<div className="inside">
												<table className="form-table">
													<tbody>
														<SettingCheckbox header="Enhanced loadCSS" name="abovethefold[loadcss_enhanced]" link={this.linkOptionState('loadCSSEnhanced')} label="Enabled" description={<span>When enabled, a customized version of loadCSS is used to make use of the <code>requestAnimationFrame</code> API following the <a href={`https://developers.google.com/speed/docs/insights/OptimizeCSSDelivery?hl=${this.lgcode}`} target="_blank" rel="noopener noreferrer">recommendations by Google</a>.</span>}></SettingCheckbox>
							...
							<SettingCheckbox header="Optimize Web Fonts" name="abovethefold[gwfo]" link={this.linkOptionState('gwfo')} label="Enabled" description={<span>When enabled, web fonts are optimized using <a href="https://github.com/typekit/webfontloader" target="_blank" rel="noopener noreferrer">Google Web Font Loader</a>.</span>}></SettingCheckbox>
							{this.getOption('gwfo') ?
											...
											<div className="inside">
												<table className="form-table">
													<tbody>
														...
														} description={<span>Select the method to load <a href={`https://developers.google.com/speed/libraries/?hl=${this.lgcode}#web-font-loader`} target="_blank" rel="noopener noreferrer">webfont.js</a> (v{this.webfontVersion})).</span>}></SettingSelect>
														...
														{this.getOption('gwfoLoadMethod') !== 'disabled' ?
															<React.Fragment>
																<SettingTextarea header="WebFontConfig" style={{ width: "100%", height: "100px", fontSize: "11px", borderColor: !this.getOption('gwfoConfigValid') ? "red" : "notacolor" }} name="abovethefold[gwfo_config]" placeholder="WebFontConfig = { classes: false, typekit: { id: 'xxxxxx' }, loading: function() {}, google: { families: ['Droid Sans', 'Droid Serif'] } };" link={this.linkOptionState('gwfoConfig')} description={<span>Enter the <code>WebFontConfig</code> variable for Google Web Font Loader. Leave blank for the default configuration. (<a href="https://github.com/typekit/webfontloader#configuration" target="_blank" rel="noopener noreferrer">more information</a>)</span>} onChange={() => { return false }/*onchange="if (jQuery(this).val() ==='') { jQuery('#sha256_warning').hide(); } else {jQuery('#sha256_warning').show();} "*/}></SettingTextarea>
																<SettingTextarea header="Google Web Fonts" style={{ width: "100%", height: this.getOption('googleFonts') > 3 ? "100px" : "50px", fontSize: "11px" }} name="abovethefold[gwfo_googlefonts]" placeholder="Droid Sans" link={this.linkOptionState('googleFonts')} description={<span>Enter the <a href={`https://developers.google.com/fonts/docs/getting_started?hl=${this.lgcode}&csw=1`} target="_blank" rel="noopener noreferrer">Google Font API</a> definitions of <a href={`https://fonts.google.com/?hl=${this.lgcode}`} target="_blank" rel="noopener noreferrer">Google Web Fonts</a> to load. One font per line. (<a href="https://github.com/typekit/webfontloader#google" target="_blank" rel="noopener noreferrer">documentation</a>)</span>}></SettingTextarea>
														...
														<tr valign="top" className="local-font-loading">
															...
															<td>
																...
																<p>Visit <a href="https://google-webfonts-helper.herokuapp.com/fonts?utm_source=wordpress&amp;utm_medium=plugin&amp;utm_term=optimization&amp;utm_campaign=o10n-x%3A%20Above%20The%20Fold%20Optimization" target="_blank" rel="noopener noreferrer">Google Webfonts Helper</a> and search for the fonts that you want to download. Select the font configuration (weight, charset and style) and download the zip-file.</p>
