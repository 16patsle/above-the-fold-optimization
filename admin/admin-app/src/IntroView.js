                        ...
                        <div id="post-body-content">
                            <div className="postbox">
                                ...
                                <div className="inside testcontent">
                                    ...
                                    <p>
                                        <a className="button button-small" href={`${thinkUrl}&hl=${this.lgcode}`} target="_blank">Google Full Spectrum Test</a>
                                        <a className="button button-small" href={`https://developers.google.com/speed/pagespeed/insights/?url=${encodeURIComponent(homeUrl)}&hl=${this.lgcode}`} target="_blank">Google PageSpeed Test</a>
                                        <a className="button button-small" href={`https://search.google.com/search-console/mobile-friendly?url=${encodeURIComponent(homeUrl)}&hl=${this.lgcode}`} target="_blank">Google Mobile Test</a>
                                        <a className="button button-small" href={`https://performance.sucuri.net/domain/${encodeURIComponent(baseHomeUrl)}`} target="_blank">Securi Server Response Time</a>
