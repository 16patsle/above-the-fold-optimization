                                                            ...
                                                            <tbody>
                                                                <SettingRadio header="Script Loader" name="abovethefold[jsdelivery_scriptloader]" link={this.linkOptionState('scriptLoader')} radios={
                                                                    ...
                                                                    },
                                                                    {
                                                                        ...
                                                                        description: <span>
                                                                                        {!this.getOption('proxy') ? <span className="description" style={{color:"red"}}>This script loader requires the <a href={proxyUrl}>Javascript proxy</a> to be enabled to bypass <a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Access_control_CORS" target="_blank">CORS</a>.</span>: null }
