    ...
    >
      ...
      <PageContent header={__('Website Monitor', 'abtfr')}>
        ...
        <p>
          ...
          , SSL certificate expiration and mobile usability (user experience) on
          all mobile devices.
        </p>
        <p>
        ...
        {getOption('uptimerobotStatus') === 'not installed' ? (
          <div>
            ...
            <p>
              <a href={getOption('uptimerobotInstallLink')} className="button">
                Install plugin
              </a>
            </p>
          </div>
        ...
        <p>
          ...
          to receive a notification when a SSL certificate is about the expire.{' '}
          <a
            href={`https://encrypted.google.com/search?hl=${lgCode}&q=${encodeURIComponent(
