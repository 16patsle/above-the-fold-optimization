...
class JavascriptView extends Component {
  constructor(props) {
    ...
    this.state.options.asyncDisabled = newlineArrayString(
      this.state.options.asyncDisabled
    );
    this.state.options.idleDelivery = newlineArrayString(
          ...
          <table className="form-table">
            <tbody>
              ...
              <tr
                ...
                style={!this.getOption('delivery') ? { display: 'none' } : {}}
              >
                      ...
                      <table className="form-table">
                        <tbody>
                          <SettingRadio
                            ...
                            link={this.linkOptionState('scriptLoader')}
                            radios={[
                              {
                                value: 'little-loader',
                                label: (
                                ...
                                description: (
                                  <span style={{ marginBottom: '5px' }}>
                                    A stable async script loader that works in
                                    old browsers.
                                  </span>
                                )
                              },
                          ...
                          <SettingCheckbox
                            ...
                            label="Enabled"
                            link={this.linkOptionState('forceAsync')}
                          ...
                          {!this.getOption('forceAsync') ? (
                            <SettingTextarea
                              ...
                              link={this.linkOptionState('async')}
                          ...
                          <SettingTextarea
                            ...
                            link={this.linkOptionState('asyncDisabled')}
                          ...
                          <SettingTextarea
                            ...
                            disabled={
                              !this.getOption('proxy') &&
                              this.getOption('scriptloader') !== 'html5'
                            }
                            link={this.linkOptionState('idleDelivery')}
                            description={
                              <span>
                                Enter a list with{' '}
                          ...
                          <SettingCheckbox
                            ...
                            label="Enabled"
                            link={this.linkOptionState('abideDeps')}
                            description={
                              <span>
                          ...
                          <SettingCheckbox
                            ...
                            label="Enabled"
                            link={this.linkOptionState('jqueryStub')}
                            description={
                              <span>
              ...
              <SettingCheckbox
                ...
                label="Enabled"
                link={this.linkOptionState('lazyScripts')}
                description={
                  <span>
