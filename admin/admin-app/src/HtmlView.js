...
class HtmlView extends Component {
	...
	<tr valign="top">
		...
		<td style="padding-top:0px;">
			...
			<textarea class="json-array-lines" name="abovethefold[html_comments_preserve]">
...
<div id="html_search_replace"><div class="loading-json-editor">{ __('Loading JSON editor...')}</div></div>
