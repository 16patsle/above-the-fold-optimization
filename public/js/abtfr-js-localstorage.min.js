Abtfr[0](function(l,h){if(l.localStorage&&l.Worker){var n=[],r=function(a){"Promise"in l?new Promise(function(b){b(a())}):"undefined"!==l.setImmediate?l.setImmediate(a):setTimeout(a,0)},d={prefix:"abtfr-",G:86400,a:{},now:function(){return+new Date/1E3},h:function(a,b){h[16]?h[16](a,{timeout:b}):a()},B:function(a,b,c){d.h(function(){var g={},e=d.now();if(g.v=e,g.i=e+(c||d.G),b instanceof Array){g.g=!0;g.u=b.length;for(var e=[],f=b.length,k=0;k<f;k++)e.push(b[k])}else e=!1,g.data=b;if(d.add(a,g),e)for(f=
