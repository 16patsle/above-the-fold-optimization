Abtfr[0](function(d,e){if(e.offline=function(){return{then:function(){}}},"serviceWorker"in d.navigator&&e[8]&&e[8][0]){var g=d.document,f=e[8];if(f[3]){var h,k=function(){e[15](function(){if(h!==navigator.onLine&&g.body){if(navigator.onLine){if(void 0===h)return;g.body.classList.remove("offline")}else g.body.classList.add("offline");h=!!navigator.onLine}})};d.addEventListener("online",k);d.addEventListener("offline",k);k()}var l=function(){navigator.serviceWorker.controller.postMessage([1,f[2],f[4],
