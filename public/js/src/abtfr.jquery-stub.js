...
Abtfr[CONFIG.LOAD_MODULE](function(window, Abtfr, document, Object) {
    ...
    window.watch('jQuery', function(id, oldval, jQuery) {
        ...
        if (JQUERY_NOCONFLICT) {
            ...
            if (ABTFRDEBUG) {
                console.info('Abtfr.jQuery.noConflict()');
            }
        }
        ...
        if (ABTFRDEBUG) {
            if (readycount > 0) {
                console.info('Abtfr.jQuery.ready()', readycount + ' callbacks');
            }
        }
