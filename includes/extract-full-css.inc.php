...
<div style="border:solid 1px #f1b70a;background-color:#ffffee;padding:5px;font-size:11px;">Url: <a href="' .
    $url .
...
foreach ($cssfiles as $file) {
    if ($file['inline']) {
        $output .=
            '<textarea style="display:none;" id="inline' .
            $file['src'] .
            '_display">' .
            htmlentities(htmlentities($file['code']), ENT_COMPAT, 'utf-8') .
            '</textarea>
<textarea style="display:none;" id="code' .
            ...
            '">' .
            htmlentities($file['inlinecode'], ENT_COMPAT, 'utf-8') .
            '</textarea><label style="display:block;border-bottom:solid 1px #efefef;padding-bottom:5px;margin-bottom:5px;" title="' .
            htmlentities(
                substr(
                    preg_replace(
                        array('|\n+|is', '|\s+|is'),
            ...
            '..."><input type="checkbox" name="cssc" value="' .
            md5($file['code']) .
            '" checked="true"> Inline <a href="javascript:void(0);" class="showinline" data-id="inline' .
            $file['src'] .
            '_display" style="cursor:help;">' .
            htmlentities(
                substr(
                    preg_replace(
                        array('|\n+|is', '|\s+|is'),
            ...
            '...</a> (' .
            human_filesize(strlen($file['inlinecode']), 2) .
            ') - Media: ' .
            implode(', ', $file['media']) .
            '</label>';
    } else {
        $output .=
            ...
            strlen($file['code']) .
            '">' .
            htmlentities($file['code'], ENT_COMPAT, 'utf-8') .
            '</textarea>
<label style="display:block;border-bottom:solid 1px #efefef;padding-bottom:5px;margin-bottom:5px;"><input type="checkbox" name="cssc" value="' .
            md5($file['src']) .
            '" checked="true"> <a href="' .
            $file['src'] .
            '" target="_blank">' .
            $file['src'] .
            '</a> (' .
            human_filesize(strlen($file['code']), 2) .
            ') - Media: ' .
            implode(', ', $file['media']) .
            '</label>';
    }
...
<a href="' .
    ...
    '?extract-css=' .
    $extractkey .
    '&amp;output=download" class="cssdownload">Download</a> <span class="cssdownloadcount"></span>
...
<script src="' .
    WPABTFR_URI .
    'public/js/extractfull.min.js"></script>
</body>
</html>';
